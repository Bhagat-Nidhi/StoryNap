...
return() =>{
  ...
  return (
    <>
      <div className={`navbar bg-base-100 max-w-screen-2x1 mx-auto md:px-20 px-4 fixed top-0left-0 right-0 ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""} my-0`}>
