...
mt-0 navbar max-w-screen-2x1 mx-auto md:px-20 px-4 fixed top-0 left-0 z-50 right-0 ${sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out":""} my-0`}>
  ...
  <input type="text" 
  className="grow outline-none dark:bg-slate-900 bg:text-white" placeholder="Search" />
